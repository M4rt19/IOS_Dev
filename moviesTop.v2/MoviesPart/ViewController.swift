...
class ViewController: UIViewController {
    ...
    var movies:[Movie] = [
        ...
        Movie(
            title: "1917",
            poster: .fir,
            description: "April 6, 1917, the height of World War I, on the Western Front in northern France. A British general assigns Corporal Blake and a fellow soldier a deadly mission. They must cross enemy territory, thought to have been abandoned by German forces, and deliver an order to call off the offensive to the 2nd Battalion Devonshire Regiment, lest 1,600 soldiers, including Blake's brother, be trapped by the enemy."
            )
    ]
